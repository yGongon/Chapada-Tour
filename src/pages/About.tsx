...
const team = [
  { name: "Léo", role: "Guia Especialista", photo: "https://ik.imagekit.io/ozcvccl1z/Guias/L%C3%A9o.jpeg" },
  { name: "Matheus", role: "Guia Especialista", photo: "https://ik.imagekit.io/ozcvccl1z/Guias/Matheus.jpeg" },
  { name: "Arthur", role: "Guia Especialista", photo: "https://ik.imagekit.io/ozcvccl1z/Guias/Arthur.jpeg" },
  { name: "Bruno", role: "Guia Especialista", photo: "https://ik.imagekit.io/ozcvccl1z/Guias/Bruno.jpeg" },
  { name: "Paulo Augusto", role: "Guia Especialista", photo: "https://ik.imagekit.io/ozcvccl1z/Guias/Paulo%20augusto.jpeg" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center mb-20 md:mb-32">
          ...
          >
            ...
            <div className="absolute -bottom-10 -left-10 bg-white p-8 rounded-3xl shadow-xl max-w-xs hidden md:block">
              ...
              <p className="mt-4 font-bold text-sm uppercase tracking-widest">— Matheus Martins</p>
            </div>
          </motion.div>
        </div>
